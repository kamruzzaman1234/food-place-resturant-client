const Footer = ()=>{
    return(
        <div>
     <footer className="grid grid-cols-1 lg:grid-cols-2 text-neutral-content">
        <div className=" bg-[#1F2937] flex justify-end ">
         <aside className="text-center px-[140px] py-[70px]">
            <h2 className="text-[32px]">Contact Us</h2> 
            <p className="text-[20px]">123 ABS Street, Uni 21, Bangladesh <br />
            +88 123456789 <br />
        ...
        <div className="bg-[#111827] flex px-[140px] py-[70px]">
        <nav className="space-y-4 text-center">
          <h6 className="text-[32px]">Follow Us</h6>
          <p className="text-[20px]">Join us on social media</p>
